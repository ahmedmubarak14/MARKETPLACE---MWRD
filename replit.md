...
├── pages/                 # Portal views (Client, Supplier, Admin, Landing, Login)
...
4. Demo credentials: `client@mwrd.com/client123`, `supplier@mwrd.com/supplier123`, `admin@mwrd.com/admin123`

...
UPDATE users SET id = 'auth-user-id-from-above' WHERE email = 'client@mwrd.com';
UPDATE users SET id = 'auth-user-id-from-above' WHERE email = 'supplier@mwrd.com';
UPDATE users SET id = 'auth-user-id-from-above' WHERE email = 'admin@mwrd.com';
```
...
2. Click "Get Started"
3. Login with: `client@mwrd.com` / `client123`

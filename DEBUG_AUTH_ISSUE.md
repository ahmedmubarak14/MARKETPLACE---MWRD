...
2. Find the user (client@mwrd.com)
3. Click the three dots → "Edit User"
4. Reset password to: `client123`
5. Try again
...
```sql
UPDATE users SET id = 'd1170655-2d28-49e7-964b-2a52f6e7deee' WHERE email = 'client@mwrd.com';
UPDATE users SET id = '0e10340a-63e9-426d-984e-99771c5f2248' WHERE email = 'supplier@mwrd.com';
UPDATE users SET id = '36ec96b2-7b81-438d-b892-3d7e4e5cd5c2' WHERE email = 'admin@mwrd.com';
```
...
```sql
SELECT * FROM auth.users WHERE email = 'client@mwrd.com';
```

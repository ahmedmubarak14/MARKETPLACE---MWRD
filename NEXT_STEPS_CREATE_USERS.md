...
('client@mwrd.com', 'John Client', 'CLIENT', 'Tech Solutions Ltd', true, 'Client-8492', 'ACTIVE', 'VERIFIED', NULL),
('supplier@mwrd.com', 'Sarah Supplier', 'SUPPLIER', 'Global Parts Inc', true, 'Supplier-3921', 'APPROVED', 'VERIFIED', 4.8),
('admin@mwrd.com', 'Admin Alice', 'ADMIN', 'mwrd HQ', true, NULL, 'ACTIVE', 'VERIFIED', NULL);
```
...
```
id                                      email
8a7b6c5d-4e3f-2g1h-0i9j-k8l7m6n5o4p3   client@mwrd.com
9b8c7d6e-5f4g-3h2i-1j0k-l9m8n7o6p5q4   supplier@mwrd.com
0c9d8e7f-6g5h-4i3j-2k1l-m0n9o8p7q6r5   admin@mwrd.com
```
...
UPDATE users SET id = '8a7b6c5d-4e3f-2g1h-0i9j-k8l7m6n5o4p3' WHERE email = 'client@mwrd.com';
UPDATE users SET id = '9b8c7d6e-5f4g-3h2i-1j0k-l9m8n7o6p5q4' WHERE email = 'supplier@mwrd.com';
UPDATE users SET id = '0c9d8e7f-6g5h-4i3j-2k1l-m0n9o8p7q6r5' WHERE email = 'admin@mwrd.com';
```
...
- [ ] Successfully logged in with client@mwrd.com
...
### "Invalid credentials"
→ Check email is exactly: `client@mwrd.com`
→ Check password is exactly: `client123`

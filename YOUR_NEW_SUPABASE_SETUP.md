...
id                                      email
---------------------------------------- -------------------
abc123-456-789...                       client@mwrd.com
def456-789-012...                       supplier@mwrd.com
ghi789-012-345...                       admin@mwrd.com
```
...
UPDATE users SET id = 'abc123-456-789...' WHERE email = 'client@mwrd.com';
UPDATE users SET id = 'def456-789-012...' WHERE email = 'supplier@mwrd.com';
UPDATE users SET id = 'ghi789-012-345...' WHERE email = 'admin@mwrd.com';
```
...
4. Click "Get Started"
5. Login with: `client@mwrd.com` / `client123`

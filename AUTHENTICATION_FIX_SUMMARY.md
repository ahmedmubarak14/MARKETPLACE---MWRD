...
login: async (email, password) => {
  ...
  validDemoPasswords = [
    'client123', 'supplier123', 'admin123',
    'demo', 'test', '123'
  ]
}
```
...
4. Email auto-fills
5. Enter password: `client123` (or `supplier123`/`admin123`)
6. Click "Sign In"
...
|------|-------|----------------|
| **Client** | `client@mwrd.com` | `client123`, `demo`, `test`, `123` |
| **Supplier** | `supplier@mwrd.com` | `supplier123`, `demo`, `test`, `123` |
| **Admin** | `admin@mwrd.com` | `admin123`, `demo`, `test`, `123` |
...
- [x] Email auto-fills to client@mwrd.com
- [x] Enter password: client123
- [x] Click "Sign In"
...
### Supplier Portal (`supplier@mwrd.com`)
...
❌ Invalid password for mock mode
   Hint: Use one of: client123, supplier123, admin123, demo, test, 123
```
...
- `client123`, `supplier123`, `admin123` (role-specific)
...
3. Verify email is exactly: `client@mwrd.com` (or supplier/admin)
...
- Each email maps to a specific role:
  - `client@mwrd.com` → Client Portal
  - `supplier@mwrd.com` → Supplier Portal
  - `admin@mwrd.com` → Admin Portal

...
1. Go to your Supabase Dashboard: https://supabase.com/dashboard/project/dxztdgjeiozumzfgvxjg
2. Navigate to **Settings** > **API**
3. Copy the following values:
   - **Project URL**: `https://dxztdgjeiozumzfgvxjg.supabase.co`

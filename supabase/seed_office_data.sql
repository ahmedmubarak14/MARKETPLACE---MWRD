...
BEGIN
  -- Get user IDs
  SELECT id INTO v_client_id FROM users WHERE email = 'client@mwrd.com';
  SELECT id INTO v_supplier_id FROM users WHERE email = 'supplier@mwrd.com';
  SELECT id INTO v_admin_id FROM users WHERE email = 'admin@mwrd.com';

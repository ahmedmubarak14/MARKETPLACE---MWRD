...
UPDATE users SET id = 'auth-user-id-for-client' WHERE email = 'client@mwrd.com';
UPDATE users SET id = 'auth-user-id-for-supplier' WHERE email = 'supplier@mwrd.com';
UPDATE users SET id = 'auth-user-id-for-admin' WHERE email = 'admin@mwrd.com';
```

### Step 7: Test Login
1. Go to http://localhost:3000/
2. Click "Get Started"
3. Login: `client@mwrd.com` / `client123`
4. Should work! ✅
